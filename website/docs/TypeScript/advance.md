...
那么到这里 TypeScript 常用语法学习就告一段落了，当然 TypeScript 还有其他的语法我们并没有讲，只是讲了 TypeScript 的一些常用语法，把这些知识学会已经足以开发一般的应用了。如果在使用 TypeScript 开发项目中遇到了其他的 TypeScript 语法知识，你可以通过 TypeScript 的[官网文档](https://www.typescriptlang.org/docs/home.html)学习。因为学基础最好的方法还是去阅读它的官网文档，敲上面的小例子。学习一门技术的基础官网文档永远是最好的第一手资料。